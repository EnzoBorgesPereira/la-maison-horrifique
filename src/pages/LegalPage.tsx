            ...
            <div className="bg-white p-8 rounded-lg shadow-md space-y-8">
                <section>
                    ...
                    <p className="text-gray-700">
                        <strong>La Maison Horrifique SAS</strong><br />
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 mb-4">3. Protection des données personnelles</h2>
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 mb-4">5. Cookies</h2>
                    <p className="text-gray-700">
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 mb-4">7. Conditions générales de vente</h2>
                    <p className="text-gray-700">
